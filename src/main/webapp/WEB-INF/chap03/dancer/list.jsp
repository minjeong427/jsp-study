...
<body>
    ...
    <ul id="dancer-list">
        ...
        <%--
            ...
            request 객체 내에 있는 dl이라는 데이터를 el을 사용하여 꺼낼 수 있다.
    ...
    <a href="/regist.do">새로운 댄서 등록하기</a>
    ...
    <script>
        ...
        $dancerList.onclick = e => {
            ...
            // 자바스크립트로 form 없이 post 요청 보내는 방법은 추후에.
